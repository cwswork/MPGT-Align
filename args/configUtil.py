...
def parse_args():
    ...
    parser.add_argument('--Out_Dir', type=str, default="../../output202409/")
    ...
    parser.add_argument('--adj_dropout', type=float, default=0.2, help='Dropout feature in trainning') # 0.2 0.1
    ...
    parser.add_argument('--train_epochs', type=int, default=1200, help='Number of epochs to train.') # 2000
    ...
    parser.add_argument('--test_freq', type=int, default=10, help=' ')
